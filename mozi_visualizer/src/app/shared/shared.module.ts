...
@NgModule({
  ...
  providers:[OpencogAPIService, AtomsService],
  exports: [ InitializeDropdown,InitializeToggle, InitializeTooltip, OrderByPipe, SearchPipe, TruncatePipe, CardTransition, ConfirmationDialogComponent]
})
