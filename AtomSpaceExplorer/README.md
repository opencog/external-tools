...
- Filtering capability is preliminary and needs to be developed further. For example, filter types in the dropdown should be generated dynamically by parsing them from the data.
