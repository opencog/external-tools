...
angular.module('impression.utilsFactory', [])
...
.factory('utils', function () {
    ...
    var indexAtoms = function (atoms, indexedAtoms) {
        if (!indexedAtoms) {
            indexedAtoms = {};
        } 
        ...
        for (var atom_index = 0; atom_index < atoms.length; atom_index++) {
            ...
            if (!indexedAtoms[atom["handle"]]) {
                //it's not there yet, create a new atom
                ...
                //atom already exists.
                //TODO: incoming/outgoing updates needed? I guess not for demo reasons.
                indexedAtoms[atom["handle"]].attention_value = atom["attentionvalue"]
                indexedAtoms[atom["handle"]].truth_value = atom["truthvalue"]
            }
